...
SceneGame = game.Scene.extend({
    ...
    init: function() {
        ...
        this.tapText = new game.BitmapText("Tap to jump", { font: 'Pixel' });
        this.tapText.position.x = game.system.width / 2 - this.tapText.textWidth / 2;
        this.tapText.position.y = this.player.sprite.position.y + 70;
        this.stage.addChild(this.tapText);
    ...
    mousedown: function(event) {
        ...
        if (this.player.body.mass === 0) {
            ...
            this.logo.remove();
            this.stage.removeChild(this.tapText);
